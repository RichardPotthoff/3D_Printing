...
difference(){
reel(diameter=20,height=20,hole_diameter=5,flat=0.5,threaddepth=0.6,threadlength=10,threadpitch=1.25,capheight=3);
...
translate([-2.8,-1.1,-10-10+9])cube([5.6,2.4,10]);
rotate(a=90,v=[0,0,1])
translate(v=[6,0,5.1])
rotate(a=32,v=[1,0,0])
